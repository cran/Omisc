#' lbind
#'
#' lbind is meant to be used in conjuction with lapply to combine elements of lists using cbind.
#'
#' @param index a list of indexes. This should count the number of items to return in the final list
#' @param alist a list of objects to be passed to cbind. They should be grouped according to which objects will be combined (e.g., if 1,2,3 are to be passed to cbind then they should be adjacent to eachother).
